...
class CPhidget_Timestamp(Structure):
    _fields_ = [("seconds",c_long),("microSeconds",c_long)]
...
class Spatial(Phidget):
    """This class represents a Phidget Spatial.
    ...
    def getAcceleration(self, index):
        ...
        try:
            result = PhidgetLibrary.getDll().CPhidgetSpatial_getAcceleration(self.handle, c_long(index), byref(value))
        except RuntimeError:
            raise
    ...
    def getAccelerationMax(self, index):
        ...
        try:
            result = PhidgetLibrary.getDll().CPhidgetSpatial_getAccelerationMax(self.handle, c_long(index), byref(value))
        except RuntimeError:
            raise
    ...
    def getAccelerationMin(self, index):
        ...
        try:
            result = PhidgetLibrary.getDll().CPhidgetSpatial_getAccelerationMin(self.handle, c_long(index), byref(value))
        except RuntimeError:
            raise
    ...
    def getAngularRate(self, index):
        ...
        try:
            result = PhidgetLibrary.getDll().CPhidgetSpatial_getAngularRate(self.handle, c_long(index), byref(value))
        except RuntimeError:
            raise
    ...
    def getAngularRateMax(self, index):
        ...
        try:
            result = PhidgetLibrary.getDll().CPhidgetSpatial_getAngularRateMax(self.handle, c_long(index), byref(value))
        except RuntimeError:
            raise
    ...
    def getAngularRateMin(self, index):
        ...
        try:
            result = PhidgetLibrary.getDll().CPhidgetSpatial_getAngularRateMin(self.handle, c_long(index), byref(value))
        except RuntimeError:
            raise
    ...
    def getMagneticField(self, index):
        ...
        try:
            result = PhidgetLibrary.getDll().CPhidgetSpatial_getMagneticField(self.handle, c_long(index), byref(value))
        except RuntimeError:
            raise
    ...
    def getMagneticFieldMax(self, index):
        ...
        try:
            result = PhidgetLibrary.getDll().CPhidgetSpatial_getMagneticFieldMax(self.handle, c_long(index), byref(value))
        except RuntimeError:
            raise
    ...
    def getMagneticFieldMin(self, index):
        ...
        try:
            result = PhidgetLibrary.getDll().CPhidgetSpatial_getMagneticFieldMin(self.handle, c_long(index), byref(value))
        except RuntimeError:
            raise
    ...
    def setDataRate(self, value):
        ...
        """
        try:
            result = PhidgetLibrary.getDll().CPhidgetSpatial_setDataRate(self.handle, c_long(value))
        except RuntimeError:
            raise
